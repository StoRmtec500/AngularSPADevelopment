...
@NgModule({
	...
	imports: [ FormsModule, HttpClientModule, BrowserModule, RouterModule, AppRoutingModule, BrowserAnimationsModule ],
	// providers: [PersonService],
	providers: [ PersonService, { provide: LOCALE_ID, useValue: 'en' } ],
